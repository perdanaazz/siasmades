...
<div class="container pt-4 bg-white">
    <div class="row">
        <div class="col">
            <h1>FORM PENGAJUAN Surat Pengantar KTP</h1>
            <hr>
            ...
            @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="kategori" id="kategori" class="form-control @error('kategori' )is-invalid @enderror" value="Pengajuan Surat Pengantar KTP" readonly>
                </div>
                <div class="form-group">
